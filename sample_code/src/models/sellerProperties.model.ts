...
SellerProperties.init(
    ...
    {
        sequelize,
        tableName: 'seller_properties',
        underscored: true,
        paranoid: true,
    }
);

SellerProperties.hasMany(PropertyFile, {
    foreignKey: 'property_id',
});
PropertyFile.belongsTo(SellerProperties, {
    foreignKey: 'property_id',
});
SellerProperties.hasMany(InternalTeamReview, {
    foreignKey: 'entity_id',
});

InternalTeamReview.belongsTo(SellerProperties, { foreignKey: 'entity_id' });
